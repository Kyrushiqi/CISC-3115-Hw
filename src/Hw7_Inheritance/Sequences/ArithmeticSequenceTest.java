...
public class ArithmeticSequenceTest {
    ...
    private static void testTwoParamConstructor() {
        ...
        sequence2.printNext(5); // expected: 4 9 14 19 24
    }
}
*/
